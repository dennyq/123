...
public class DataController extends ControllerPageBase {
  @Autowired
  private DataService service;
  private static final Logger logger = LoggerFactory.getLogger(NoticeController.class);
  private String rootKey = "data";
  ...
  public String graph(HttpServletRequest request,Model model) throws Exception {
    ...
    model.addAllAttributes(service.graph(req));
  ...
  public String excelTransform(HttpServletRequest request,Model model) throws Exception{
    ...
    model.addAttribute("type", "indata");
    model.addAttribute("title", "내부센서데이터");
