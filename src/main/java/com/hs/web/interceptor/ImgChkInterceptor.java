...
import com.hs.web.service.LoginService;
...
public class ImgChkInterceptor extends HandlerInterceptorAdapter {
  private static final Logger logger = LoggerFactory.getLogger(ImgChkInterceptor.class);
  ...
  public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) throws Exception {
    ...
    if (chkController == null) {
      ...
      String noauthUrl = request.getContextPath() + "/noauth";
