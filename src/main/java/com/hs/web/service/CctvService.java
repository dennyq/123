...
@Service
public class CctvService extends ServiceBase {

  private static final Logger logger = LoggerFactory.getLogger(CctvService.class);
  @Autowired private CctvMapper mapper;
  ...
  public ResultMap detail(RequestMap req) {
    ...
    res.put("data", memberMapper.detail(req));
