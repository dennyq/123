...
public class AuthAspect {
    ...
    @Pointcut("(execution(public * com.hs.web.controller.MachineController..*(..))  ))")
    public void loginChk() {
    }

    @Around("loginChk()")
    public Object loginChk(ProceedingJoinPoint joinPoint) throws Throwable {
    ...
    private Object resultWithProceed(ProceedingJoinPoint joinPoint) throws Throwable {
        ...
        for (Object obj : thisObjArr) {
            ...
            if (obj instanceof HttpServletRequest || obj instanceof MultipartHttpServletRequest) {
                ...
                if (!isLogin) {
                    throw new BizException("9008", "로그인하셔야합니다.");
                }
