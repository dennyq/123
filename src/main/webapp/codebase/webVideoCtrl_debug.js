!function (e) {
    if (!e.WebVideoCtrl) {
        var t = function () {
            ...
            e.GetSelectWndInfo = function (e) {
                ...
                Z("?í‰ª∂‰∫ã‰ª∂ÔºöPluginEventHandler iEventTypeÔº?s iParam1: %s, iParam2: %s", e, t, s), b == e || M == e ? f.I_Stop(t) : L == e ? f.I_StopRecord(t) : q == e && f.I_StopVoiceTalk(), a.cbEvent && a.cbEvent(e, t, s)
            }, e.GetHttpInfo = function (e, t) {
                Z("http?çÂ∫îËøîÂõûÔºöhttp?∂Ê?Ôº?s, http?∞ÊçÆÔº?s", e, t), et.prototype.processCallback(e, t)
            };
            var Z = function () {
                if (a.bDebugMode) {
                    var e = k(arguments);
            ...
            var Y = function (e, t, s, n, r, o, i) {
                ...
                I.extend(a, i), I.extend(a, {
                    success: function (a) {
                        var c = new J;
                        c.szIP = e, 2 == t ? (c.szHttpProtocol = "https://", c.iHttpsPort = s) : (c.szHttpProtocol = "http://", c.iHttpPort = s), c.iCGIPort = s, c.szAuth = n, c.iDeviceProtocol = r, c.oProtocolInc = o, l.push(c), Z("‰ΩøÁî®%s?èË??ªÂΩï?êÂäü", r), N(c), i.success && i.success(a)
                    }, error: function (e, t) {
                        i.error && i.error(e, t)
                    }
                }), o.login(e, s, n, a)
    ...
    tt.prototype.getDigitalChannelInfo = function (e, t) {
        ...
        var i = [{}, {pan: 0, tilt: n.iPTZSpeed}, {pan: 0, tilt: -n.iPTZSpeed}, {
            ...
            pan: n.iPTZSpeed,
            tilt: -n.iPTZSpeed
        }, {}, {speed: n.iPTZSpeed}, {speed: -n.iPTZSpeed}, {speed: n.iPTZSpeed}, {speed: -n.iPTZSpeed}, {speed: n.iPTZSpeed}, {speed: -n.iPTZSpeed}], a = "", c = {};
        switch (n.iPTZIndex) {
            case 1:
            case 2:
            case 3:
        ...
        var u = new et, l = {type: "PUT", url: o, async: !1, auth: e.szAuth, data: a, success: null, error: null};
