...
<section class="content-header">
  ...
  <ol class="breadcrumb">
    ...
    <li><a href="<c:url value="/member/list"/>">의견올리기 </a></li>
    <li>
      <a href="<c:url value="/member/detail/${data.memberid}"/>"><c:if test="${empty data && changePwd ne 'Y'}">의견올리기 등록</c:if><c:if test="${not empty data && changePwd ne 'Y'}">의견올리기 상세</c:if><c:if test="${changePwd eq 'Y'}">비밀번호변경</c:if></a>
    </li>
  </ol>
</section>
<!-- Main content -->
