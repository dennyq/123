...
<body>
<form id="searchFrm" action="<c:url value="/outerData/graphSearch"/>" class="form-horizontal" method="post">
<section class="content-header">
  ...
  <ol class="breadcrumb">
    ...
    <li ><a href="<c:url value="/outerData/graph"/>">데이터 관리</a></li>
    <li ><a href="<c:url value="/outerData/graph"/>">데이터 관리</a></li>
  </ol>
</section>
        ...
        <div class="col-md-12">
          <div class="bottom-25">
            ...
            <div class="custom-tab-parent">
                ...
                <div >내부 센서그래프 보기</div>
                <div>외부 센서데이터 보기</div>
                <div class="active">외부 센서그래프 보기</div>
                <div>영농일지</div>
            </div>
            <!--// tab end -->
            ...
            <div class="box-body ">
              ...
              <img width="700" src="${grpPath}" alt="grp1"/>
...
//      todayBtn: true
    ...
    $('#searchBtn').click(function(){
      $('#searchFrm').attr('action','/outerData/graphSearch');
