  ...
  <input type="hidden"  name="isNew" value="Y"/>
              ...
              <div class="col-md-6">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-6">
                    <input name="password" type="password"  id="password" placeholder="아이디" class="form-control">
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-6">
                    <input name="name"  id="name" placeholder="아이디" class="form-control">
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-6">
                    <input name="telephone"  id="telephone" placeholder="아이디" class="form-control">
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-6">
                    <input name="handphone"  id="handphone" placeholder="아이디" class="form-control">
                  </div>
                </div>
              </div>
              ...
              <div class="col-md-6 right">
                <div class="form-group">
                  ...
                  <div class="col-sm-6">
                    <input name="cfrm_password" type="password" id="cfrm_password" placeholder="아이디" class="form-control">
                  </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-6">
                    <input name="joindate"  id="joindate" placeholder="아이디" class="form-control datepicker">
                  </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-6">
                    <input name="usestartdate"  id="usestartdate" placeholder="아이디" class="form-control datepicker">
                  </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-6">
                    <input name="useenddate"  id="useenddate" placeholder="아이디" class="form-control datepicker">
                  </div>
...
//      console.log(this);
    ...
    <%--$('.datepicker').datepicker({--%>
      <%--locale: {--%>
        <%--format: 'YYYY.MM.DD'--%>
      <%--},--%>
      <%--&lt;%&ndash;<c:if test="${param['usestartdate_low'] != null and param['usestartdate_low'] != '' }">&ndash;%&gt;--%>
      <%--&lt;%&ndash;"startDate":"${param['usestartdate_low']}",&ndash;%&gt;--%>
      <%--&lt;%&ndash;"endDate":"${param['usestartdate_high']}"&ndash;%&gt;--%>
      <%--&lt;%&ndash;</c:if>&ndash;%&gt;--%>
      <%--&lt;%&ndash;<c:if test="${param['usestartdate_low'] == null or param['usestartdate_low'] == '' }">&ndash;%&gt;--%>
