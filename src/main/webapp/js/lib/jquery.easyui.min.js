...
},message:"메일형식에 맞춰주세요."},url:{validator:function(_409){
...
$.fn.calendar.defaults={width:180,height:180,fit:false,border:true,firstDay:0,weeks:["일","월","화","수","목","금","토"],months:["1월","2월","3월","4월","5월","6월","7월","8월","9월","10월","11월","12월"],year:new Date().getFullYear(),month:new Date().getMonth()+1,current:new Date(),onSelect:function(date){
}};
})(jQuery);
(function($){
function init(_46f){
