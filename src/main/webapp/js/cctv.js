...
$(function () {
	...
	//WebVideoCtrl.I_InsertOBJECTPlugin("divPlugin3");
	//WebVideoCtrl.I_InsertOBJECTPlugin("divPlugin4");
	//WebVideoCtrl.I_InsertOBJECTPlugin("divPlugin5");
	//WebVideoCtrl.I_InsertOBJECTPlugin("divPlugin6");
	//WebVideoCtrl.I_InsertOBJECTPlugin("divPlugin7");
	//WebVideoCtrl.I_InsertOBJECTPlugin("divPlugin8");
...
//var g_iWndIndex= 1;
    ...
    //
    console.log($('input[name=camera1]').val());
